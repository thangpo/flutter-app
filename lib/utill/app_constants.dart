...
class AppConstants {
  ...
  static const String slogan = 'VNShop247: Tất cả trong tay, thỏa sức chi tiêu, thỏa sức bay xa.';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.vi, languageName: 'Vietnamese', countryCode: 'VN', languageCode: 'vi'),
  ];
