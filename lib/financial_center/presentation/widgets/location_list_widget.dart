            ...
            children: List.generate(rightColumn.length, (index) {
              return Padding(
                ...
                child: _LocationCard(
                  ...
                  onTap: () =>
                      _openTourSpotlight(context, rightColumn[index]),
                ),
              );
            }),
          ),
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color:
                  Colors.black.withOpacity(widget.isDark ? 0.35 : 0.08),
                  blurRadius: 8,
            ...
            child: ClipRRect(
              ...
              child: Stack(
                children: [
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: [
                            const Color(0xFF0052A4).withOpacity(0.18),
                            const Color(0xFF0052A4).withOpacity(0.30),
                          ],
                        ),
                      ),
                    ),
                  ...
                  // Chip rating – bỏ blur, chỉ dùng container mờ
                  Positioned(
                    left: 12,
                    bottom: 12,
                    child: Container(
