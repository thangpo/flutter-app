...
class _OrderScreenState extends State<OrderScreen> {
  ...
  void initState() {
    ...
    isGuestMode = !Provider.of<AuthController>(Get.context!, listen: false).isLoggedIn();
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
            ...
            child: Row(
              ...
              children: [
                _buildMenuItem(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const TourOrderScreen(),
                      ),
                    );
                  },
                ),
                _buildMenuItem(
                  ...
                  onTap: () {
                    // Không cần làm gì vì đã ở trang này
                  },
                ),
                _buildMenuItem(
                  title: 'Vé máy bay',
                  ...
                  icon: Icons.flight,
                  onTap: () {
                    // TODO: chuyển sang trang flight order
                    // Navigator.push(context, MaterialPageRoute(builder: (_) => const FlightOrderScreen()));
                  },
                ),
              ],
            ),
          ...
          Expanded(
            child: _buildEcommerceOrderList(),
          ),
        ],
      ),
    );
                ...
                child: PaginatedListView(
                  ...
                  itemView: ListView.builder(
                    ...
                    itemBuilder: (context, index) => OrderWidget(
                        orderModel:
                        orderController.orderModel?.orders![index]),
                  ),
                ),
              )
  ...
  Widget _buildMenuItem({
    ...
    bool isSelected = selectedMenu == keyName;
