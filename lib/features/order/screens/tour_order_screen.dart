            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.filter_list_rounded, color: oceanBlue, size: 24),
                ),
                  ...
                  child: DropdownButtonFormField<String>(
                    ...
                    decoration: InputDecoration(
                      ...
                      enabledBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12),
                        borderSide: BorderSide(color: lightOceanBlue.withOpacity(0.5)),
                      ),
          ...
          Expanded(
            child: _isLoading
              ...
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(Icons.sailing_outlined, size: 80, color: lightOceanBlue),
                  const SizedBox(height: 16),
                  const Text(
              ...
              itemBuilder: (context, index) {
                ...
                final title = service['title'] ?? 'Tour không xác định';
