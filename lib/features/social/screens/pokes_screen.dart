...
class _PokesScreenState extends State<PokesScreen> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() => context.read<SocialController>().fetchPokes());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(getTranslated('who_poked_me', context) ?? 'Ai chọc tôi?'),
      ),
      body: ctrl.loadingPokes
          ? const Center(child: CircularProgressIndicator())
          : pokes.isEmpty
          ? const Center(child: Text("Chưa ai chọc bạn 😢"))
          : ListView.separated(
